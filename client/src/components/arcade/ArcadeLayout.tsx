      ...
      <div className="how-it-works">
        ...
        <div className="rule-card">
          ...
          <p className="rule-text">
            ...
            Chase Pac-Royale. Tag them and you become Pac-Royale — steal the lead.
          </p>
        </div>
        <div className="rule-card">
          <span className="rule-icon" aria-hidden>
          ...
          <p className="rule-text">
            ...
            Anyone can collect for points. Pac-Royale gets 1.5× speed. Respawn every 30s.
          </p>
        </div>
        <div className="rule-card">
          <span className="rule-icon" aria-hidden>
          ...
          <p className="rule-text">
            ...
            One random fruit on the map. Only Pac-Royale can collect: Cherry 25, Orange 50, Apple
            75, Lemon 100 pts.
          </p>
        </div>
        <div className="rule-card">
    ...
    <section className="players-section" aria-label="Players">
      ...
      <div className="players-grid">
        <div className="player-card is-pac">
          ...
          <p className="player-name">PAC-ROYALE</p>
...
export function ArcadeFooter() {
  return (
    <footer className="arcade-footer">
      ...
      <span className="footer-text">© PAC-ROYALE</span>
